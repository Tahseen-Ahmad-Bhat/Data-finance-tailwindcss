    ...
    <div className="max-w-[1240px] mx-auto py-16 px-4 grid lg:grid-cols-3 gap-8 text-gray-300">
      <div className="p-4">
        ...
        <p className="py-4">
          ...
          explicabo inventore necessitatibus, asperiores autem.
        </p>
        <div className="flex items-center justify-between md:w-[75%] my-4">
      ...
      <div className="lg:col-span-2 flex justify-between md:mt-6 px-4">
        <div>
          <h6 className=" text-gray-400 font-bold">Solutions</h6>
          <ul>
